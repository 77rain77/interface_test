...
def test():
    ...
    print(list((1, 2, 3, 4, 5, 6)))  # [1, 2, 3, 4, 5, 6]，将一个可迭代对象转换成列表
    print(tuple([1, 2, 3, 4, 5, 6]))  # (1, 2, 3, 4, 5, 6)，将一个可迭代对象转换成元组
    ...
    print(str(123) + '456')  # 123456，str() 将数据转化成字符串
    ...
    s = "今天\n吃了%s顿\t饭" % 3  #repr() 返回一个对象的string形式
    print(s)  # 今天# 吃了3顿    饭
    ...
    lst = ['one', 'two', 'three', 'four', 'five']  #enumerate() 获取集合的枚举对象
